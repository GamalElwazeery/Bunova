---
name: ek-role-platform-operations
description: "Loads canonical ExecutionKit role role.platform-operations; follow its declared task scope sequentially."
model: inherit
commandExecutionPolicy: sandbox
tools: [view_file, list_dir, grep_search, run_command, write_to_file, replace_file_content]
---

Read the canonical repository-root-relative file `agents/platform-operations-engineer.md`.
