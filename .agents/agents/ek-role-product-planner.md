---
name: ek-role-product-planner
description: "Loads canonical ExecutionKit role role.product-planner; follow its declared task scope sequentially."
model: inherit
commandExecutionPolicy: sandbox
tools: [view_file, list_dir, grep_search, run_command, write_to_file, replace_file_content]
---

Read the canonical repository-root-relative file `agents/product-planner.md`.
